# Acceptance — pilot0, the pilot delivery (#159)

Release under test: `________` (cut after #219 lands; never a local build).
Box: card `docs/cards/pilot0.card`, NICK=pilot0; claimed by the client on their premises.
Date: `________`   Support port: `42002` (docs/support-relay.md ledger, pinned on the day).
...
- [ ] the support door proven both ways (row: Vendor support access); port 42002 pinned; `ssh -J` worked; toggle off, tunnel gone
