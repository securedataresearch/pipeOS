...
`pipeos status` warns when overlay and live drift. Runlevels are NOT in
overlay/ — they're generated by `scripts/40-build-apkovl.sh` (mk_runlevel
lines); a live `rc-update add` must be mirrored there.
