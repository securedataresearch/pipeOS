...
def LC():
    return lg.Ledger(dir=LDIR, transcripts=TR, rates=RATES, conf=CONF, runs_log=RUNS, sessions_dir=SESS, webchat_sid=WSID, pipe_bin=PIPE, schedule=SCHED, cluster_last=LAST)
