...
verbs = ("pipeos schedule", "pipeos usage", "pipeos card set", "pipeos secrets phrase", "pipeos assistant password", "pipeos nas account", "pipeos selfupdate image", "pipeos watchdog", "pipeos deploy-overlay", "pipeos vault", "pipeos wake", "pipeos work", "pipeos cluster", "pipeos secrets request", "pipeos lan", "pipeos blink", "pipeos updates")
